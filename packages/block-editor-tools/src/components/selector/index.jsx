...
// Custom hooks.
import useDebounce from '@alleyco/block-editor-tools';
...
Selector.defaultProps = {
  type: 'post',
  className: '',
  emptyLabel: __('No items found', 'alley-scripts'),
  label: __('Search for items', 'alley-scripts'),
  maxPages: 5,
  multiple: false,
  placeholder: __('Search for items', 'alley-scripts'),
  subTypes: [],
  selected: [],
  threshold: 3,
};
